...
happyActOffsets = HappyA# "\x13\x00\x13\x00\x11\x00\x00\x00\x0d\x00\x0f\x00\x00\x00\x0e\x00\x0c\x00\x0b\x00\x0a\x00\x09\x00\x00\x00\x00\x00\x00\x00"#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# "\x05\x00\x07\x00\x08\x00\x00\x00\x00\x00\x08\x00\x00\x00\x03\x00\x06\x00\x00\x00\x01\x00\x04\x00\x00\x00\x00\x00\x00\x00"#

happyDefActions :: HappyAddr
happyDefActions = HappyA# "\x00\x00\x00\x00\x00\x00\xfc\xff\x00\x00\xfd\xff\xfe\xff\x00\x00\xf9\xff\x00\x00\x00\x00\xf9\xff\xfb\xff\xfa\xff"#

happyCheck :: HappyAddr
happyCheck = HappyA# "\xff\xff\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x01\x00\x03\x00\x01\x00\x03\x00\x02\x00\x01\x00\xff\xff\x04\x00\x03\x00\x01\x00\x04\x00\x02\x00\x05\x00\x02\x00\x01\x00\xff\xff\xff\xff\xff\xff\xff\xff"#

happyTable :: HappyAddr
happyTable = HappyA# "\x00\x00\x0b\x00\x05\x00\x08\x00\x05\x00\x04\x00\x05\x00\x0d\x00\x02\x00\x09\x00\x06\x00\x04\x00\x00\x00\x0b\x00\x0d\x00\x04\x00\x0b\x00\x08\x00\xff\xff\x08\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00"#
...
happyReduction_1 happy_x_2
	...
	happyIn4
		 (Node (detWeight happy_var_2) happy_var_1 happy_var_2
	)}}
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	Int happy_dollar_dollar -> cont 1#;
	ListOpen -> cont 2#;
	ListClose -> cont 3#;
	Separator -> cont 4#;
	_ -> happyError' (tk:tks)
...
happyError_ 5# tk tks = happyError' tks
...
parseIntTree tks = happyRunIdentity happySomeParser where
