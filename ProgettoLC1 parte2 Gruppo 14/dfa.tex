...
\path	(1)	edge			node	{\texttt{([a-zA-Z\textbackslash\\-\textbackslash\\']+)}}	(2)
	...
	(4)	edge			node	{[\textvisiblespace]}	(5)
		edge	[loop below]	node	{\texttt{([a-zA-Z\textbackslash\\-\textbackslash\\']+)}}	(4)

	(5)	edge	[bend left]	node	{\texttt{([a-zA-Z\textbackslash\\-\textbackslash\\']+)}}	(6)
		edge			node	{\texttt{[0]}}	(7)
	...
	(6)	edge	[bend left]	node	{[\textvisiblespace]}	(5)
		edge	[loop above]	node	{\texttt{([a-zA-Z\textbackslash\\-\textbackslash\\']+)}}	(6)
