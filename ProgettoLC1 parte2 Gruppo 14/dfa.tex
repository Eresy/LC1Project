...
\path	(1)	edge	[bend left]	node	{\texttt{([a-zA-Z\textbackslash\\-\\']+)}}	(2)

	(2)	edge	[bend left]	node	{[\textvisiblespace]}	(3)
		edge	[loop below]	node	{\texttt{([a-zA-Z\textbackslash\\-\\']+)}}	(2)
      	

	(3)	edge	[bend left]	node	{\texttt{([a-zA-Z\textbackslash\\-\\']+)}}	(4)
		edge	[loop above]	node	{\texttt{[\textvisiblespace]}}	(3)

	(4)	edge	[bend left]	node	{[\textvisiblespace]}	(5)
		edge	[loop above]	node	{\texttt{([a-zA-Z\textbackslash\\-\\']+)}}	(4)

	(5)	edge	[bend left]	node	{\texttt{([a-zA-Z\textbackslash\\-\\']+)}}	(6)
		edge			node	{\texttt{[0]}}	(7)
		edge			node	{\texttt{[12]}}	(8)
		edge			node	{\texttt{[3]}}	(9)
		edge	[loop right]	node	{[\textvisiblespace]}	(9)

	(6)	edge	[bend left]	node	{[\textvisiblespace]}	(5)
		edge	[loop above]	node	{\texttt{([a-zA-Z\textbackslash\\-\\']+)}}	(6)

	(7)	edge			node	{\texttt{[1-9]}}	(10)
	(8)	edge			node	{\texttt{[0-9]}}	(10)
	(9)	edge			node	{\texttt{[01]}}	(10)
	(10)	edge			node	{\texttt{"/"}}	(11)

	(11)	edge			node	{\texttt{[0]}}	(12)
		edge			node	{\texttt{[1]}}	(13)

	(12)	edge	[bend left]	node	{\texttt{[1-9]}}	(14)
	(13)	edge	[bend right]	node	{\texttt{[0-2]}}	(14)
	(14)	edge	[left]		node	{\texttt{"/"}}	(15)
	(15)    edge	[left]		node	{\texttt{[0-9]}}	(16)
        (16)    edge			node	{\texttt{[0-9]}}	(17)
        (17)    edge			node	{\texttt{[0]}}	(18)

        (18)    edge			node	{\texttt{[0-9]}}	(19)
		edge	[loop left]	node	{\texttt{[0]}}	(18)
